...
=======
        profileFrame proFrame = new profileFrame();
        proFrame.add(this.plant8);
>>>>>>> 1e4135b57a441275b9d9a6ca650a1a8093c61ea0
    ...
    private void plant2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_plant2ActionPerformed
        ...
        profileFrame proFrame = new profileFrame(false);
        proFrame.add(this.plant2);
        Plant up = new Plant();
        up.setID(plant2);
